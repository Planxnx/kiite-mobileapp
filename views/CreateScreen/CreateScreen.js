        ...
        <View style={styles.container}>
            ...
            <View style={styles.createForm} >
                ...
                { isLoading ? <TouchableOpacity disabled={true}><View style={styles.buttontext}><ActivityIndicator/></View></TouchableOpacity> : 
                    <TouchableOpacity onPress={this.signUp}><View style={styles.buttontext} ><Text style={{textAlignVertical:'center',fontSize:vh(1.799)}}>Login</Text></View></TouchableOpacity>
                }
             </View>
